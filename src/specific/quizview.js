...
const update = async () => {
    ...
    document.querySelector('#no').innerHTML = `จำนวนข้อ: ${con.qu.length}`;
        ...
        document.querySelector('.quiz_').querySelector('img').style.display = "block";
        }else{
            document.querySelector('.quiz_').querySelector('img').style.display = "none";
        }
        if(con.qu[i].a1Img !== ""){
        document.querySelector("#a1i").src = `./imgs/quiz/${con.qu[i].a1Img}`;
                document.querySelector("#a1i").style.display = "block";
        }else{
            document.querySelector("#a1i").style.display = "none";
        }
        if(con.qu[i].a2Img !== ""){
            document.querySelector("#a2i").src = `./imgs/quiz/${con.qu[i].a2Img}`;
            document.querySelector("#a2i").style.display = "block";
        }else{
            document.querySelector("#a2i").style.display = "none";
        }
        if(con.qu[i].a3Img !== ""){
            document.querySelector("#a3i").src = `./imgs/quiz/${con.qu[i].a3Img}`;
            document.querySelector("#a3i").style.display = "block";
        }else{
            document.querySelector("#a3i").style.display = "none";
        }
        if(con.qu[i].a4Img !== ""){
            document.querySelector("#a4i").src = `./imgs/quiz/${con.qu[i].a4Img}`;
            document.querySelector("#a4i").style.display = "block";
        }else{
            document.querySelector("#a4i").style.display = "none";
        }
        if(con.qu[i].a1 !== ""){
